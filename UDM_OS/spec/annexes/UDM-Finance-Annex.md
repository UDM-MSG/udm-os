...
## 1) Purpose
Describe how **Finance** maps into the UDM OS regulator. This annex explains the domain signals and how they compress into **S/C/P** -> **OPEN/WATCH/CLOSED** decisions with receipts and replay.

## 2) Signals -> S/C/P (bounded in [0,1])
- **Stability (S)**: regime/volatility stability, liquidity persistence
- **Coherence (C)**: cross-indicator and cross-venue consistency, price/volume agreement
- **Pressure (P)**: volatility, drawdown/VAR stress, credit/liquidity pressure
...
## 5) State semantics for Finance
- OPEN: normal execution/allocation
- WATCH: reduce leverage/risk, tighten limits, increase hedges
- CLOSED: halt risky strategies, move to safe assets, manual review
