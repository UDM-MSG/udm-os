...
## 1) Purpose
Describe how **Healthcare** maps into the UDM OS regulator. This annex explains the domain signals and how they compress into **S/C/P** -> **OPEN/WATCH/CLOSED** decisions with receipts and replay.

## 2) Signals -> S/C/P (bounded in [0,1])
- **Stability (S)**: vitals/clinical stability, protocol adherence
- **Coherence (C)**: cross-clinician/system agreement, longitudinal patient coherence
- **Pressure (P)**: clinical risk, adverse event pressure, resource strain
...
## 5) State semantics for Healthcare
- OPEN: proceed with standard of care
- WATCH: increase monitoring, second opinions, decision support prompts
- CLOSED: stop non-essential actions, mandatory review/escalation
