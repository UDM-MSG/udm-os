# UDM - Ethics Charter (People's Guarantee)
...
**Goal:** User-facing charter: transparency, replayability, refusal of unsafe actions. No action without a reason (receipt); deterministic replay; hysteresis (double-check) before acting.
