...
## 1) Purpose
Describe how **Supply Chain** maps into the UDM OS regulator. This annex explains the domain signals and how they compress into **S/C/P** -> **OPEN/WATCH/CLOSED** decisions with receipts and replay.

## 2) Signals -> S/C/P (bounded in [0,1])
- **Stability (S)**: lead-time and fill-rate stability, forecast error reduction
- **Coherence (C)**: inventory/vendor data agreement, plan-vs-actual alignment
- **Pressure (P)**: backlog, bottleneck indices, demand spike/shortage pressure
...
## 5) State semantics for Supply Chain
- OPEN: normal replenishment/fulfillment
- WATCH: buffer inventory, soft caps, dynamic routing
- CLOSED: freeze risky commits, invoke contingency sourcing
