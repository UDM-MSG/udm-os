# UDM - Wellbeing Annex (Personal Clarity)
...
**Goal:** Map UDM to healthy decision-making. CLOSED = pause/reflect; WATCH = gather clarity; OPEN = safe to act. S = emotional stability; C = cognitive coherence; P = stress load.
