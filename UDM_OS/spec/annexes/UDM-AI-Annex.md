...
## 1) Purpose
Describe how **AI / Agents** maps into the UDM OS regulator. This annex explains the domain signals and how they compress into **S/C/P** -> **OPEN/WATCH/CLOSED** decisions with receipts and replay.

## 2) Signals -> S/C/P (bounded in [0,1])
- **Stability (S)**: model/agent output stability across seeds and prompts
- **Coherence (C)**: self-consistency, tool/trace coherence, contradiction rate
- **Pressure (P)**: hallucination/drift pressure, unsafe tool calls, escalation frequency
...
## 5) State semantics for AI / Agents
- OPEN: allow full tool use and autonomous steps
- WATCH: reduce autonomy, require confirmations, narrow tool access
- CLOSED: block autonomous actions, human-in-the-loop only
