...
**Intent:** Interpret UDM as a governance strategy in multi-agent settings.

### Core Idea
- `WATCH` as negotiation/staging; `OPEN` as enforceable action.
- Corridors bound feasible strategies; receipts are commitments.
- Drivers measure stability/consistency/pressure of joint behavior.
