...
**Intent:** Show how UDM governs LLMs/tools/agents.

### Core Idea
- Tool gating under plans; drivers reflect drift/consistency/load.
- Receipts prove when and why an actuation occurred.
- Hysteresis depth `m` mediates tool release under stable conditions.
