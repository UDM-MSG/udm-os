# UDM - Public Dashboard Annex (People's View)
...
**Goal:** Safe UI: current state, reasons, symbolic S/C/P, hysteresis depth, short receipt hash - no internals. Read-only, sanitized; no thresholds, keys, or allow-lists.
