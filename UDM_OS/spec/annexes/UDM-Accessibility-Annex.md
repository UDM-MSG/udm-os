...
**Goal:** Inclusive understanding (ADHD/autism/LD/trauma-informed). Clear color/state icons; voice and captions; What is happening? content; gentle error states.
