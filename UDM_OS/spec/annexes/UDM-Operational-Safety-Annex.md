...
**Intent:** Turn UDM into an auditable decision register for operations.

### Core Idea
- Receipt schema -> traceability, justification, replay conformance.
- Incident analysis via `/replay` -> determinism guarantees.
- Symbolic SLOs (e.g., false-OPEN <= ε) tied to test packs.
