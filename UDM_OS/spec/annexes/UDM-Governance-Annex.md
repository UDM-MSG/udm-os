...
## 1) Purpose
Describe how **Governance** maps into the UDM OS regulator. This annex explains the domain signals and how they compress into **S/C/P** -> **OPEN/WATCH/CLOSED** decisions with receipts and replay.

## 2) Signals -> S/C/P (bounded in [0,1])
- **Stability (S)**: policy outcome stability, enforcement consistency
- **Coherence (C)**: cross-agency/legal alignment, precedent consistency
- **Pressure (P)**: conflict/uncertainty, compliance risk, public safety pressure
...
## 5) State semantics for Governance
- OPEN: enact policy actions as planned
- WATCH: add checks, require extra attestations, staged rollouts
- CLOSED: pause enactment, emergency review
