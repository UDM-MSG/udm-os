...
**Intent:** Make S/C/P and state transitions human-readable without exposing internals.

### Core Idea
- Show which signals influenced S/C/P (symbolically).
- Visualize hysteresis: last `m` in-band windows and reasons.
- Explainable narratives tied to reason codes (why not OPEN yet).
